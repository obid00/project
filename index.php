...
<head>
	<meta charset="UTF-8">
	<title>Маҳсуорим кишоварзи</title>
	  ...
	  <div class="modal-dialog modal-dialog-centered" role="document">
	    <div class="modal-content shadow">
	      <div class="modal-header">
	        <h5 class="modal-title">Ворид кардани маҳсулот</h5>
	      ...
	      <div class="modal-body">
	        <form action="" method="post">
	        	<div class="form-group">
	        		<input type="text" class="form-control" name="name" value="" placeholder="Номи маҳсулот">
	        	</div>
	        	<div class="form-group">
	        		<input type="text" class="form-control" name="mablag" value="" placeholder="Нархи маҳсулот">
	        	</div>
	        	
	      </div>
	      <div class="modal-footer">
	        <button type="button" class="btn btn-secondary" data-dismiss="modal">Рад кардан</button>
	        <button type="submit" name="submit" class="btn btn-primary">Илова кардан</button>
	      </div>
	  		</form>
	    </div>
	  </div>
